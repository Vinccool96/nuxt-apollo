  ...
  <div flex flex-col gap-4>
    <NCard p-4>
      ...
      <div class="flex flex-wrap gap-3 items-center">
        <NTextInput v-model="githubToken" icon="carbon-logo-github" placeholder="Your Github Token" />
      ...
      <div class="mt-4 flex flex-wrap gap-3 items-center">
        <NButton :disabled="!githubToken" @click="getViewer"> Load @me </NButton>

        <NButton :disabled="!githubToken" @click="getNuxtDiscussions"> Load Nuxt Discussions </NButton>
      </div>
    </NCard>
